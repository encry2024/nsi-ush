...
@section('content')
	...
	<div class="row">
		<div class="large-12 columns">
			<table class="large-12" id="successful"></table>
		</div>
	</div>
	@endif
@endsection
...
$(document).ready( function() {
	...
	$.getJSON("{{ URL::to('/') }}/fetch/successful-sales",function(data) {
		$('#successful').dataTable({
			...
			[
				...
				{"sTitle": "Success Date", "mDataProp": "su_date", "sClass": "size-14"}
			...
			[
				...
				},
				{
					...
					// 'full' is the row's data object, and 'data' is this column's data
					// e.g. 'full[0]' is the comic id, and 'data' is the comic title
					return '<label ><input type="hidden" value="<label>' +full['dte_2'] + '</label>">' + full["su_date"] + '</label>';
					}
				}
			],
